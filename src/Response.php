...
use gijsbos\Http\Interfaces\ResponseInterface;
...
class Response implements ResponseInterface
{
     ...
     * @param array $headers
     */
    public function __construct($parameters = null, $statusCode = 200, $headers = array())
    {
        $this->setParameters($parameters !== null ? $parameters : array());
    ...
    {
        return $this->getParameter("errorDescription");
    }
    ...
    public function getErrorString() : string
    {
        if(!$this->isSuccessful())
        {
            ...
            if($error = $this->getError())
                $string[] = sprintf("%s (%d)", $error, $this->getStatusCode());

            if($errorDescription = $this->getErrorDescription())
